        ...
        <div className="footer-column">
          ...
          <div className="directions-to-administrator">
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              to="https://www.google.com/maps?q=42.499292,%2078.412108"
            >
              Adress: Isa Kuchukova
            </Link>
            <Link
              className="Tel"
              target="_blank"
              rel="noreferrer"
              to="tel:+996 500 92 37 37"
            >
              +996 500 92 37 37
            </Link>
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              to="mailto:orozobekovdosbol07@gmail.com"
            >
              orozobekovdosbol07@gmail.com
            </Link>
          </div>
        </div>
        <div className="footer-column">
          ...
          <div className="network-icons">
            <Link
              to="https://api.whatsapp.com/send?phone=996500923737"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <Link
              to="https://instagram.com/orozobekovv.d"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <Link
              to="https://www.facebook.com/profile.php?id=100092658991524&mibextid=LQQJ4d"
              target="_blank"
              rel="noreferrer"
            >
              <svg
